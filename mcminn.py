...
bib['Shamshiri2018'] = {
  'author': [shamshiri_s, rojas_j, gazzola_l, fraser_g, mcminn_p, mariani_l, arcuri_a],
...
bib['Anand2013'] = {
  'author': [anand_s, burke_e, chen_t, clark_j, cohen_m, grieskamp_w, harman_m, harrold_m, mcminn_p],
...
bib['Holcombe2012'] = {
  'author': [holcombe_m, adra_s, bicak_m, chin_s, coakley_s, graham_a, green_j, greenough_c, jackson_d, kiran_m, macneil_s, malekidizaji_a, mcminn_p, pogson_m, poole_r, qwarnstrom_e, ratnieks_f, rolfe_m, smallwood_r, sun_t, worth_d],
...
bib['Baars2011'] = {
  'author': [baars_a, harman_m, hassoun_y, lakhotia_k, mcminn_p, tonella_p, vos_t],
...
bib['Harman2008'] = {
  'author': [harman_m, baresel_a, binkley_d, hierons_r, hu_l, korel_b, mcminn_p, roper_m],
